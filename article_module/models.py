...
class Article(models.Model):
    ...
    creat_date = models.DateTimeField(auto_now_add=True, editable=False, verbose_name='تاریخ ثبت')

    def __str__(self):
        return self.title

    def get_jalali_creat_date(self):
        return date2jalali(self.creat_date)

    def get_jalali_creat_time(self):
        return self.creat_date.strftime('%H:%M')
