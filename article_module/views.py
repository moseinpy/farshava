...
class ArticlesListView(ListView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['banners'] = SiteBanner.objects.filter(is_active=True, position__iexact='article_list')
        return context
...
class ArticleDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['banners'] = SiteBanner.objects.filter(is_active=True, position__iexact='article_detail')
        return context
